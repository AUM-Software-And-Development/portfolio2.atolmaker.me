...
namespace EricDeeTTSTS.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            string connectionStringLocal = @"Data Source=***;Initial Catalog = ***;Integrated Security = ***;Connect Timeout = **;Encrypt=***;TrustServerCertificate=***;ApplicationIntent=***;MultiSubnetFailover=***";
            string connectionStringHTTP = @"Data Source=***; Initial Catalog=***; User ID=***; Password=***;";

            return connectionStringHTTP;
        }
        ...
        {
            return Redirect("https://github.com/atolbmaker");
        }
    }
}
