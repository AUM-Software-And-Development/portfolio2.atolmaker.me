...
function LanguageMap() {
    ...
    do {
        ...
        do {
            ...
            ASCIILookahead = InputInstruction[Index].charCodeAt(CharIndex);

            if (EmergencyExit === 900) { break; }
            if (ASCIICurrent < 65) { CharIndex--; SubtractiveCountWhichBeganFromInstruction++; break; }
            if (ASCIILookahead === 46) { break; }
    ...
    do {
        ...
        if (Switch === 1) {
            ...
            if (Case === 20) {
                ...
                PostToIndex += InputInstruction;
                Switch = 0;
                window.location.href = "http://portfolio1.atolmaker.me/HTML/Roadmap/RoadmapLander.html";
            }
            ...
            if (Case === 21) {
                ...
                PostToIndex += InputInstruction;
                Switch = 0;
                window.location.href = "https://github.com/atolbmaker";
            }
        }
