...
function DrawTreeLeftTop(startX, startY, length, angle, branchWidth, color1, color2) {
    ...
    // Branch right
    DrawTreeLeftTop(0, -length, length * 0.72, angle + 6, branchWidth);
    // Branch left
    DrawTreeLeftTop(0, -length, length * 0.72, angle - 6, branchWidth);
...
function DrawTreeRightTop(startX, startY, length, angle, branchWidth, color1, color2) {
    ...
    if (length < 10) {
        Context_TreeCanvasRightTop.beginPath();
        Context_TreeCanvasRightTop.arc(0, -length, 9, 0, Math.PI / 2);
    ...
    // Branch right
    DrawTreeRightTop(0, -length, length * 0.72, angle + 6, branchWidth * 0.6);
    // Branch left
    DrawTreeRightTop(0, -length, length * 0.72, angle - 6, branchWidth * 0.6);
...
function DrawTreeLeftTopRandom(startX, startY, length, angle, branchWidth, color1, color2) {
    ...
    if (length < 9) {
        Context_TreeCanvasLeftTop.beginPath();
        Context_TreeCanvasLeftTop.arc(0, -length, 9, 0, Math.PI / 2);
    ...
    // Branch right
    DrawTreeLeftTopRandom(0, -length, length * 0.72, angle + curve + Math.random(), branchWidth * 0.6);
    // Branch left
    DrawTreeLeftTopRandom(0, -length, length * 0.72, angle - curve + Math.random(), branchWidth * 0.6);
...
function GenerateRandomTreeLeft() {
    ...
    let length = Math.floor((Math.random() * 9) + 90);
    let angle = Math.random();
    let branchWidth = (Math.random() * 27) + 10;
